...
void ClientAppBrowser::OnBeforeCommandLineProcessing(
  ...
  if (process_type.empty()) {
	...
	//	command_line->AppendSwitchWithValue("register-pepper-plugins", "C:\\cef_binary\\cefclient\\Debug\\pepflashplayer.dll;application/x-shockwave-flash"
	...
	command_line->AppendSwitchWithValue("ppapi-flash-version", "20.0.0.209");
