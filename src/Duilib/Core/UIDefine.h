...
#define DUI_MSGTYPE_LBTN_ITEMCLICK 		   (_T("lbtn_itemclick"))
#define DUI_MSGTYPE_RBTN_ITEMCLICK 		   (_T("rbtn_itemclick"))
#define DUI_MSGTYPE_TABSELECT              (_T("tabselect"))

#define DUI_MSGTYPE_ITEMSELECT 		   	   (_T("itemselect"))
#define DUI_MSGTYPE_ITEMEXPAND             (_T("itemexpand"))
#define DUI_MSGTYPE_WINDOWINIT             (_T("windowinit"))
#define DUI_MSGTYPE_ONSIZE				   (_T("onsize"))
...
#define DUI_MSGTYPE_HOTKEYCHANGED		   (_T("hotkeychanged"))

#define DUI_MSGTYPE_GIFPLAYEND			   (_T("gifplayend"))
...
#define	 DUI_CTR_CUSTOMEDIT					     (_T("CustomEdit"))
...
#define  DUI_CTR_COMBINATIONLAYOUT			     (_T("CombinationLayout"))
#define  DUI_CTR_LISTLABELELEMENT                (_T("ListLabelElement"))

#define	 DUI_CTR_TRANSPARENTLAYOUT				 (_T("TransparentLayout"))
#define	 DUI_CTR_OPTIONLAYOUT					 (_T("OptionLayout"))
