...
namespace DuiLib
{
	...
	public:
		...
		virtual CDuiString NavigateError(IDispatch *pDisp,VARIANT * &url,VARIANT *&TargetFrameName,VARIANT *&StatusCode,VARIANT_BOOL *&Cancel) { return _T("");}
		...
		virtual void DocComplete(IDispatch *pDisp, VARIANT* sURL){};
